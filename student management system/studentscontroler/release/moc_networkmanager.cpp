...
QT_MOC_LITERAL(1, 15, 14), // "serverShutdown"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 7) // "message"

    },
    "NetworkManager\0serverShutdown\0\0message"
};
...
void NetworkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->serverShutdown((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetworkManager::serverShutdown)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void NetworkManager::serverShutdown(const QString & _t1)
{
